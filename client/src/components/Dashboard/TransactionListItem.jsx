    ...
    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 mb-3">
      <div className="flex justify-between items-center" onClick={() => setIsExpanded(!isExpanded)}>
        ...
        <div className="flex items-center">
          <span className={`font-semibold text-base ${transaction.type === 'credit' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
        ...
        <div className="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4 space-y-3">
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              >
                <span className="text-sm">{transaction.category?.name || 'Selecione uma categoria...'}</span>
